# The credit for this code goes entirely to Lars Magnus Nordeide, and
# his blog here: 
# http://larsnordeide.com/2014/pysdl2-playing-a-sound-from-a-wav-file.html
# This was the very first bit of source code that I managed to get
# working sound out of. It's goal is different to mine, but it
# confirmed to me that PySDL and sound works.
...
def main():
    ...
    sound_file = RESOURCES.get_path("balloonpop.wav")
